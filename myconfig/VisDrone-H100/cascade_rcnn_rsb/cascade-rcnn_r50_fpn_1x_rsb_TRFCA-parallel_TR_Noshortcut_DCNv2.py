...
# ===========================================
TAGS = ["casc_r50_fpn_1x", 'rsb', 'GA']
GROUP_NAME = "cascade-rcnn"
ALGO_NAME = "cascade-rcnn_r50_fpn_1x_rsb_TRFCA-parallel_TR_Noshortcut_DCNv2"
...
model = dict(
    backbone=dict(
        plugins=[
            dict(
                cfg=dict(
                    type='TransformerWithFCA',
                    num_heads=8,
                    reduction=16,
                    FCA_pos='parallel_TR_Noshortcut',
                    pos_after_conv=2),
