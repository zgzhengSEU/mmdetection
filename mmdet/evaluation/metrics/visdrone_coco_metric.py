...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[9] = _summarize(0, maxDets=self.params.maxDets[-1]) # new
...
class VisDrone_CocoMetric(BaseMetric):
    ...
    """
    default_prefix: Optional[str] = 'VisDrone_coco'
            ...
            if metric == 'proposal':
                ...
                if self.classwise:  # Compute per-category AP
                    ...
                    if self.mode == 'test':
                        ...
                        os.mkdir(temp_results_per_category_dir)
                        import pickle
                        with open(f'{temp_results_per_category_dir}/results_per_category.pkl', 'wb') as f:
                            pickle.dump(results_per_category, f)
                            print(f'save {temp_results_per_category_dir}/results_per_category.pkl')
                ...
                ap_ar = coco_eval.stats[:]
                if self.mode == 'test':
                    temp_ap_ar_dir = 'work_dirs/model_test/temp_ap_ar_dir'
                    os.system(f'rm -rf {temp_ap_ar_dir}')
                    os.mkdir(temp_ap_ar_dir)
                    np.save(f'{temp_ap_ar_dir}/ap_ar.npy', ap_ar)
                    
                logger.info(f'{metric}_mAP_copypaste: {ap[0]:.3f} '
                            f'{ap[1]:.3f} {ap[2]:.3f} {ap[3]:.3f} '
                            f'{ap[4]:.3f} {ap[5]:.3f}')
                logger.info(f'{metric}_mAR_copypaste: {ar[0]:.3f} '
                            f'{ar[1]:.3f} {ar[2]:.3f} {ar[3]:.3f} '
                            f'{ar[4]:.3f} {ar[5]:.3f} {ar[6]:.3f}')
