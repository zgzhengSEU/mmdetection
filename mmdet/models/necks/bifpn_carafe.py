    ...
    def forward(self, x):
        ...
        p6_up = self.conv6_up(
            self.combine(weight[0] * p6_in +
                         weight[1] * self.p6_upsample_CARAFE(p7_in)))
        ...
        p5_up = self.conv5_up(
            self.combine(weight[0] * p5_in +
                         ...
                         weight[1] * self.p5_upsample_CARAFE(p6_up)))
        ...
        p4_up = self.conv4_up(
            self.combine(weight[0] * p4_in +
                         ...
                         weight[1] * self.p4_upsample_CARAFE(p5_up)))
        ...
        p3_out = self.conv3_up(
            self.combine(weight[0] * p3_in +
                         ...
                         weight[1] * self.p3_upsample_CARAFE(p4_up)))
