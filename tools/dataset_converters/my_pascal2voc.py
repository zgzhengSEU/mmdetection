...
def cvt_annotations(devkit_path, split, out_file):
    ...
    #     return
    # xml_list = glob.glob(osp.join(devkit_path, "annotations", split) + "/*.xml")
    ...
    # ]
    xml_list = glob.glob(osp.join(devkit_path, "annotations", split) + "/*.xml")
    img_names = [os.path.splitext(os.path.split(xml)[-1])[0] for xml in xml_list]
...
def parse_args():
    ...
    parser.add_argument('--devkit_path',default='/home/S20zhengzg/mmdet3/data/BJH', help='pascal voc devkit path')
    parser.add_argument('-o', '--out-dir', default='/home/S20zhengzg/mmdet3/data/BJH/annotations', help='/home/S20zhengzg/mmdet3/data/BJH/annotations')
    parser.add_argument(
        '--out-format',
        default='coco',
        choices=('pkl', 'coco'),
...
def main():
    ...
    for split in ['train', 'test']:
        ...
        cvt_annotations(devkit_path, split,
                        osp.join(out_dir, split + out_fmt)) 
    print('Done!')
